...
final class RuleRepository {
    ...
    static void register(Page page, List<RouteRule> rules) {
     ...
     */
    static void register(BrowserContext context, List<RouteRule> rules) {
     ...
     */
    static void register(Object context, List<RouteRule> rules) {
    ...
    static void removePageRules(Page page) {
        if (page == null) return;
    ...
    static void removeContextRules(Object context, Set<String> patterns) {
    ...
    static void clearContext(Object context) {
    ...
    static void cleanupClosedContext(BrowserContext context) {
        if (context == null) return;
    ...
    static void clearAllUnifiedRuleStores() {
        for (Map<String, List<RouteRule>> scoped : RouteContextState.CONTEXT_RULES_BY_CONTEXT.values()) {
            detachChains(scoped);
        }
