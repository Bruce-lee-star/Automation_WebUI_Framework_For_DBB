...
public final class RouteMonitorSession {
     ...
     */
    public static void startMonitorSession(Object context, RouteRule rule, String normalizedPattern) {
    ...
    public static void stopSessionsFor(Object ctx, String normalized) {
        SESSIONS.entrySet().removeIf(entry -> {
